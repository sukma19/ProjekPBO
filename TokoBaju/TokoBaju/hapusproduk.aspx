<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hapusproduk.aspx.cs" Inherits="TokoBaju.hapusproduk" %>
...
<body class="container">
    ...
    <table>  
        ...
        <tr>  
            ...
            <td>:</td>  
            <td>  
                <asp:TextBox ID="txtidproduk" runat="server"></asp:TextBox>  
            </td>  
        </tr>  
        <tr >  
            <td colspan="3">  
                <asp:Button ID="btnDelete" runat="server" Text="Hapus" OnClick="btnDelete_Click" type="button" class="btn btn-success"/>  
