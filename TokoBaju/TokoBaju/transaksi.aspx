<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transaksi.aspx.cs" Inherits="TokoBaju.transaksi" %>
...
<body class="container">
    ...
    <table>  
        ...
        <tr>  
            ...
            <td>:</td>  
            <td>  
                <asp:TextBox ID="txtidtransaksi" runat="server"></asp:TextBox>  
            </td>  
        </tr>  
        <tr>  
            ...
            <td>:</td>  
            <td>  
                <asp:TextBox ID="txtnamapelanggan" runat="server"></asp:TextBox>  
            </td>  
        </tr>  
        <tr>  
            <td>ID Produk</td>  
            <td>:</td>  
            <td>  
                <asp:TextBox ID="txtidproduks" runat="server"></asp:TextBox>  
            </td>  
        </tr>
        <tr>  
            <td>Jumlah Produk</td>  
            <td>:</td>  
            <td>  
                <asp:TextBox ID="txtjumlahproduk" runat="server"></asp:TextBox>  
            </td>  
        </tr>
        <tr>  
        <td colspan="2">  
            <asp:Button ID="btnInsertion" runat="server" Text="Selesai" OnClick="btnInsertion_Click" type="button" class="btn btn-success"/>  
