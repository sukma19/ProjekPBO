<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editproduk.aspx.cs" Inherits="TokoBaju.editproduk" %>
...
<body class="container">
    ...
    <table>  
        ...
        <tr>  
        <td colspan="2">  
            <asp:Button ID="btnUpdation" runat="server" Text="Perbarui" OnClick="btnUpdation_Click" type="button" class="btn btn-success"/>
